...
def revision_view(page: ft.Page, sistema, usuario_actual, on_nav_click=None, on_change=None, on_profile_click=None) -> ft.Container:
    if not usuario_actual or usuario_actual.rol != "admin":
        ...
        return page_shell(usuario_actual, "REVISIÓN", body, on_nav_click=on_nav_click, on_profile_click=on_profile_click)
