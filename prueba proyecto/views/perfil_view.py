...
def perfil_view(page: ft.Page, sistema, usuario_actual, cuentas_sesion=None,
                 on_nav_click=None, on_change=None, on_profile_click=None,
    ...
    return page_shell(usuario_actual, "PERFIL", body, on_nav_click=on_nav_click, on_profile_click=on_profile_click)
