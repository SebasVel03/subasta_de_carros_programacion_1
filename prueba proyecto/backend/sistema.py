...
class AdministradorCompraVenta:
    ...
    def obtener_mis_compras_ganadas(self, id_usuario):
        ...
        vendida). No hay una pestaña dedicada para esto todavía — se usa
        para mostrarle al ganador, dentro de 'Subastas Activas', un acceso
        directo al detalle del carro y al chat con el vendedor para
